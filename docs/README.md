...
_This project is a port of CS-Script to .NET Core. Basically it is a .NET Core version of these popular scripting engine._
...
_Integration of CS-Script.Core with these tools is on the way._
...
\* _statistics does not include x64 downloads nor downloads after Notepad++ discontinued shipping editor with the plugin manager x86 included_ 
